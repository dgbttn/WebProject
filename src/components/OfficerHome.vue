    ...
    export default {
            ...
            this.$http.post('http://localhost/uFaculty/staff/StaffController/getStaffByID',{
                ...
                .then(function (data) {
                    ...
                    this.officerInfo = {
                        ...
                        address: data.body.data[0].address,
                        staff_id: staff_id
                    };
        ...
        methods: {
            ...
            editTopic() {
                ...
                this.$http.post(url,{
                    topic_id: this.researchTopics[this.topicEditing].topic_id,
            ...
            removeTopic(index) {
                if (confirm("Bạn chắc chắn muốn xóa Chủ đề này chứ?")) {
                    ...
                    this.$http.post(url,{
                        topic_id: this.researchTopics[index].topic_id
                    })
                        .then(function (data) {
                            console.log(data);
